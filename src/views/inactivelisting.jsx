...
function InactiveLeaseTable() {
  ...
  useEffect(() => {
    axios
      ...
      .then((response) => {
        setleaseList(response.data.inactive);
      })
      .catch((error) => {
        console.log(error);
      });
  ...
  return (
    <>
      <Table striped bordered hover variant="red" className="table-red">
        <thead>
          <tr>
            <th>lease No</th>
            <th>Client No</th>
...
export default InactiveLeaseTable;
